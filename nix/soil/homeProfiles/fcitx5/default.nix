      ...
      "fcitx5/conf/classicui.conf".source = pkgs.writeText "fcitx5_classicui.conf" (
        generators.toINIWithGlobalSection { } {
          globalSection = {
            ...
            Font = "${config.font.fontconfig.chinese.defaultFont.serif} 11";
            MenuFont = "${config.font.fontconfig.chinese.defaultFont.serif} 11";
            PerScreenDPI = true;
            PreferTextIcon = false;
            ShowLayoutNameInIcon = true;
            Theme = "default";
            TrayFont = "${config.font.fontconfig.chinese.defaultFont.sansSerif} 11";
            UseAccentColor = true;
            UseDarkTheme = false;
